  ...
  data(){
    return{
      tiles:[
        ...
        {title:"Spiral Dots", subTitle:"Rotating Circles Connected Together", footer:"SVG, Tracing",  pageName:"spiralDots", production:true, icon:""},
        ...
        {title:"Audio Flavors", subTitle:"Analyzes Audio and Creates Visual Orb", footer:"SVG, FFT",  pageName:"audioFlavors", production:false, icon:""},
